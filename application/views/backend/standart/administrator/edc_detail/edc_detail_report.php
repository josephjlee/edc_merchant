...
var url='<?= site_url('administrator/edc_detail/getModalResult1/') ?>'+dataTahun+'/'+dataBulan+'/'+Wilayah+'/'+TYPE_MID+'/'+type;
...
//  var url='<?= site_url('administrator/report/getModal/') ?>'+dataTahun+'/'+dataBulan+'/'+Wilayah;
var url='<?= site_url('administrator/edc_detail/get_export1/') ?>'+dataBulan+'/'+dataTahun+'/'+dataType;

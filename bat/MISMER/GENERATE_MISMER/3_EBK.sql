...
LEFT(a.MID,1) IN(5,8,9) AND LEFT(a.SOURCE_CODE,1)!='U'
 ...
 -- AND EXTRACT(MONTH FROM STR_TO_DATE(concat(concat(20,SUBSTRING(a.OPENDATE,5,2)),'/',SUBSTRING(a.OPENDATE,3,2),'/',SUBSTRING(a.OPENDATE,1,2)), '%Y/%m/%d') )=1
-- AND OPENDATE='191018'

-- GROUP BY WILAYAH,CHANNEL,TYPE_MID
;
-- select count(*) from ebk_detail where TAHUN=2019
-- select count(*) from ebk_detail where TAHUN=2018 AND BULAN=12 -- 1950 1983 1989

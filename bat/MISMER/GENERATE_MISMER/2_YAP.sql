...
LEFT(a.MID,1) =3 AND LEFT(a.SOURCE_CODE,1)='U'
...
-- AND EXTRACT(MONTH FROM STR_TO_DATE(concat(concat(20,SUBSTRING(a.OPENDATE,5,2)),'/',SUBSTRING(a.OPENDATE,3,2),'/',SUBSTRING(a.OPENDATE,1,2)), '%Y/%m/%d') )=12
-- AND OPENDATE='191018'

-- GROUP BY WILAYAH,CHANNEL,TYPE_MID
;

-- select count(*) from yap_detail where BULAN=12 AND TAHUN=2018 AND generate_at='2019-01-04 16:57:47'-- 1778 -- 2051
-- select distinct generate_at from yap_detail where BULAN=12 AND TAHUN=2018 -- 1778 -- 2051
